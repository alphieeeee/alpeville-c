...
This repository contains my capstone project. The goal is to build a production-ready web application while following modern software engineering practices and using AI-assisted development responsibly.
...
Produce production-ready, maintainable, and scalable code that follows modern web development best practices.
